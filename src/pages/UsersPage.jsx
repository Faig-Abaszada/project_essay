...
export default function UsersPage() {
    ...
    return (
        <div className="users-page">
            ...
            <TableComponent rows={rows} loading={loading} paginatedRows={paginatedRows} openDeleteModal={openDeleteModal} />
            <TablePagination count={Math.ceil(rows.length / rowsPerPage)} page={page} onChange={(e, newPage) => setPage(newPage)} />
            <DeleteModal open={modalOpen} onClose={closeModal} onDelete={handleDelete} selectedRow={selectedRow} isDeleting={isDeleting} />
